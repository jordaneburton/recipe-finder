// PSEUDO CODE
// GIVEN 
//      I load the page I am presented with an input box and a prompt to enter my desired recipe and a ‘My Cookbook’ button in the header. 
// WHEN 
...
// THEN 
//      The page displays a handful of the selected recipe types for me to read, with a star to save the recipe. 
...
// THEN 
//      I am taken to a page with the recipes that I previously starred with an option to remove the recipe. 
